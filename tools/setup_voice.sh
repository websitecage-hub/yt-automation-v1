...
sudo -H pip install torch torchaudio --index-url "$CPU_INDEX"
sudo -H pip install --ignore-installed --no-deps chatterbox-tts
...
sudo -H pip install --ignore-installed "torch==2.14.0+cpu" "torchaudio==2.11.0+cpu" \
